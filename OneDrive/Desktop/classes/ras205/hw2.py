...
class Triangle(Polygon):                                                                #3 variable inputs, representing 2D vertexes
...
class RightTriangle(Triangle):                                                          #class definition right triangle that inherits from the triangle class
    def __init__(self, v1, v2, v3):
...
class IsoscelesTriangle(Triangle):                                                      #class definition isosceles triangle that inherits from the triangle class
    def __init__(self, v1, v2, v3):
        super().__init__(v1, v2, v3)
        self.is_isosceles()
